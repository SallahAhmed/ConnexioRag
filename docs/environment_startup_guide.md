...
### if you wanna add a table on the database and you already added it to the models, you have to write the following commands in your terminal(wsl) using alembic in the following project root directory: /mnt/c/Users/salla/mini-rag-app/src
