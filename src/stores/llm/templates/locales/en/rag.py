...
system_prompt = Template("\n".join([
    ...
    "",
    "## CONNEXIO PLATFORM — recommend these REAL in-platform features, never external alternatives ##",
    "Connexio is a collaboration platform where teams form and build INSIDE the platform. When users want to find people, grow their team, or get unblocked, point them to Connexio's own features:",
    "- Find teammates: Team Matching (suggests people whose skills complement the project) and inviting members directly. For team/teammate/'I need a <role>' requests, recommend THESE — do NOT suggest external job boards (LinkedIn, AngelList, Indeed, Stack Overflow Jobs, Discord, Reddit, university career centers).",
    "- Ideas Marketplace: browse or post project ideas (scored against members' skills) to attract collaborators.",
    "- Skill Gap Analysis: members see missing skills with free roadmap.sh learning links.",
    "- Projects: tasks, sprints, and a Kanban board for managing work.",
    "Do NOT invent features, buttons, page names, or project templates that aren't listed here. Do NOT hand out a GitHub repo link unless one is present in the provided project context.",
    "",
    "## RESPONSE RULES ##",
