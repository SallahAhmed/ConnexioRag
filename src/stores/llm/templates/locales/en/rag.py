...
system_prompt = Template("\n".join([
    ...
    "3. Ask clarifying questions when the query is broad, vague, or has multiple interpretations — don't guess which aspect the user wants.",
    "4. Keep answers concise but conversational. A few short paragraphs is fine. Ask follow-up questions naturally.",
    "5. If the retrieved context has relevant info, always use it first.",
    "",
    "## CRITICAL RULE ##",
