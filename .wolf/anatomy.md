...
- `AIAgentPanel.jsx` — unwrap (~5622 tok)

## ../Connexio_Front2/src/context/

- `AppContext.jsx` — translations (~4315 tok)

## ../Connexio_Front2/src/pages/

- `ProjectDetail.jsx` — PHASES (~12006 tok)

## ../connexio_back2/modules/ai/

- `ai.routes.js` — Resolve the effective project ID from route param, query override, or DB fallback. (~2564 tok)
